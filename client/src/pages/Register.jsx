  ...
  return (
    <div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-6'>
      <div className='w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow-xl'>
        ...
        {/* LEFT */}
          <div className='w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center'>
            ...
            <form className='py-8 flex flex-col gap-5' onSubmit={handleSubmit(onSubmit)}>
              ...
              <TextInput
              name="email" placeholder="email@example.com" label="Email Address" type="email" register={
                register("email", {
              ...
              <TextInput
              name="password" placeholder="Password" label="Password" type="password" register={
                register("password", {
              ...
              <TextInput
               placeholder="Password" label="Confirm Password" type="password" register={
                register("cPassword", {
                  validate: (value) => {
        ...
        {/* RIGHT */}
          <div className='hidden w-full h-full lg:w-1/2 h-full lg:flex flex-col items-center justify-center bg-blue'>
                <div className='relative w-full flex items-center justify-center'>

                    <img src={BgImage} alt='Bg Image' className='w-48 2xl:w-64 h-48 xl:h-64 rounded-full object-cover' />
